...
public class TransactionGenerator {
    ...
    TransactionGenerator(List<Tuple<String, Double>> rawItems, GenerateTransactionCommand command) {
    ...
    private <T extends Transaction, E extends Item> void generateConcreteTransactions(TransactionSupplier<T, E> transactionSupplier, BiFunction<Integer, Integer, E> itemsSupplier) {
